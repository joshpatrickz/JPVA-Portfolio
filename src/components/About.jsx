...
const About = () => {
  return (
    <div
      name="about"
      id="About"
      className="w-full h-[400px] flex flex-col bg-[#E1C340] shadow-xl"
    >
      <div className="md:max-w-[800px] sm:max-w-[600px] max-w-[400px] md:mt-10 sm:mt-10 mt-10 mb-10 mx-auto text-center justify-center">
